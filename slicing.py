...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 15 17:35:38 2018
...
def slice_and_dice(text=text):
    ...
    for lines in text_list:
        #print(lines)
        if lines.split()[0][0] == lines.split()[0][0].lower():
            lines_list= lines.split()
            #print(lines_list)
            #results.append(lines_list[-2:])
            results = results + lines_list[-2:]
            #print(results)
...
print(slice_and_dice(text=text))